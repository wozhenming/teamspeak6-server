...
// 聊天点歌可用指令（面板管理开关）：dian=点歌，play=播放，pause=暂停，next=切歌，clear=清队列，loop=循环，status=状态
const CHAT_CMD_DEFAULT = { dian: true, play: true, pause: true, next: true, clear: true, loop: true, status: true };
